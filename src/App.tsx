...
const styles: Record<string, React.CSSProperties> = {
  ...
  headerTitle: { fontSize: 36, fontWeight: 900, letterSpacing: '0.15em', color: RED_BRIGHT, fontFamily: 'Georgia, "Times New Roman", serif', textShadow: `2px 2px 0px ${BLACK}` },
  headerSubtitle: { fontSize: 10, letterSpacing: '0.3em', color: GRAY_MID, marginTop: 4 },
  backButton: { backgroundColor: 'transparent', border: `2px solid ${RED}`, color: BONE, padding: '8px 16px', fontSize: 12, fontWeight: 700, letterSpacing: '0.15em', cursor: 'pointer', alignSelf: 'flex-start' },
  statusBar: { backgroundColor: GRAY_DARK, borderBottom: `1px solid ${RED}`, padding: '12px 16px', fontSize: 11 },
  webModeNotice: { backgroundColor: RED, color: BONE, padding: '6px 10px', marginBottom: 8, fontSize: 10, letterSpacing: '0.1em', fontWeight: 700, textAlign: 'center' },
  statusRow: { display: 'flex', justifyContent: 'space-between', padding: '2px 0' },
  statusLabel: { color: GRAY_MID, letterSpacing: '0.15em', fontWeight: 700 },
  statusValue: { fontFamily: 'Menlo, monospace', fontWeight: 700 },
  errorText: { color: '#FF4444', marginTop: 8, fontSize: 11 },
  sectionHeader: { padding: '24px 16px 12px', fontSize: 11, letterSpacing: '0.25em', fontWeight: 700, color: RED, borderBottom: `1px solid ${GRAY_DARK}` },
  sitesContainer: { padding: 16, display: 'flex', flexDirection: 'column', gap: 16 },
  siteCard: { backgroundColor: GRAY_DARK, border: `2px solid ${RED}`, padding: 0, cursor: 'pointer', textAlign: 'left', color: BONE, fontFamily: 'inherit', overflow: 'hidden', display: 'flex', flexDirection: 'column' },
  siteCardImage: { width: '100%', height: 180, backgroundSize: 'cover', backgroundPosition: 'center', borderBottom: `2px solid ${RED}` },
  siteCardBody: { padding: 16 },
  siteCardCategory: { fontSize: 10, letterSpacing: '0.25em', color: RED_BRIGHT, fontWeight: 700, marginBottom: 6 },
  siteCardTitle: { fontSize: 22, fontWeight: 900, fontFamily: 'Georgia, serif', marginBottom: 8, color: BONE },
  siteCardDesc: { fontSize: 13, lineHeight: 1.4, color: '#BBB' },
  siteCardDistance: { fontSize: 11, marginTop: 10, color: RED_BRIGHT, fontWeight: 700, letterSpacing: '0.1em' },
  heroImage: { width: '100%', height: 280, backgroundSize: 'cover', backgroundPosition: 'center', borderBottom: `3px solid ${RED}` },
  detailBody: { padding: 20 },
  detailCategory: { fontSize: 11, letterSpacing: '0.25em', color: RED_BRIGHT, fontWeight: 700, marginBottom: 8 },
  detailTitle: { fontSize: 32, fontWeight: 900, fontFamily: 'Georgia, serif', lineHeight: 1.1, marginBottom: 12 },
  detailDistance: { fontSize: 13, color: RED_BRIGHT, fontWeight: 700, marginBottom: 16 },
  detailDivider: { height: 2, backgroundColor: RED, margin: '16px 0' },
  detailDescription: { fontSize: 15, lineHeight: 1.6, color: BONE },
  detailPara: { marginBottom: 16 },
  directionsButton: { width: '100%', backgroundColor: RED, border: 'none', color: BONE, padding: '16px', fontSize: 14, fontWeight: 900, letterSpacing: '0.2em', cursor: 'pointer', marginTop: 16, fontFamily: 'inherit' },
  imageCredit: { fontSize: 10, color: GRAY_MID, textAlign: 'center', marginTop: 16, letterSpacing: '0.1em' },
  devTools: { margin: '32px 16px', padding: 16, backgroundColor: GRAY_DARK, border: `1px dashed ${GRAY_MID}` },
  devToolsHeader: { fontSize: 10, letterSpacing: '0.25em', color: GRAY_MID, fontWeight: 700, marginBottom: 12 },
  devButton: { width: '100%', backgroundColor: 'transparent', border: `1px solid ${GRAY_MID}`, color: BONE, padding: '10px', fontSize: 12, cursor: 'pointer', marginBottom: 8, fontFamily: 'inherit', letterSpacing: '0.05em' },
  footer: { textAlign: 'center', fontSize: 10, color: GRAY_MID, padding: 16, letterSpacing: '0.1em' },
};
